...
# 2026-09-23T12:43:00Z est substitué (sed) par l'heure de fin de l'import arrondie à la minute supérieure avant l'envoi.
...
poetry run python scripts/audit/data_inventory.py --pairs BTC/USDT,ETH/USDT,SOL/USDT --skip-vision --now 2026-09-23T12:43:00Z --output $OUT/inventory.json --markdown $OUT/inventory.md
rc=$?
