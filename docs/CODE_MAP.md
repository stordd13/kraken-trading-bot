...
6. ✅ B3 : `exchange` obligatoire dans `multi_timeframe.py:236` et `multi_pair_registry.py:91` (plus de default `"binance"`). ⚠️ Conventions de timestamp divergentes Binance (open time) vs Bybit (fin de période) — `skills/database.md`, dette 11 de `PROJECT_CONTEXT.md` (B4).
