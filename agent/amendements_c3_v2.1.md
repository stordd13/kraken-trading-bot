...
> **Statut : PROPOSÉ, en revue.** Ce paquet est un texte : il se lit comme le protocole s'est lu au gate 2,
> sans code. Rien de ce qu'il contient n'est appliqué tant qu'il n'est pas adopté ; l'application est une
> tâche agent séparée (plan mode), cadrée après la revue.
>
